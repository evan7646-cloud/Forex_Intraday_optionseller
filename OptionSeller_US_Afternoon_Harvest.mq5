...
{ // 區塊開始
   ...
   if(sym == "EURNZD" || sym == "EURJPY") return 2.5; // EURNZD/EURJPY 美盤最佳為 2.5σ
   if(sym == "GBPJPY" || sym == "GBPUSD") return 2.2; // GBPJPY/GBPUSD 最佳為 2.2σ
...
{ // 區塊開始
   ...
   if(sym == "GBPUSD" || sym == "EURUSD") return 2.0; // GBPUSD/EURUSD 最佳為 2.0 ATR
   if(sym == "GBPJPY" || sym == "EURNZD" || sym == "EURJPY") return 1.5; // GBPJPY/EURNZD/EURJPY 最佳為 1.5 ATR
